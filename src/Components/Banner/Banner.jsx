...
const Banner = () => {
  return (
    <section id='home' className="relative min-h-screen text-black lg:pt-30 pt-20 pb-10 px-6 sm:px-10 md:px-16 lg:px-20 overflow-hidden lg:mb-8 lg:mt-12 lg:mx-20">
      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12 relative z-10">
        ...
        <div className="flex-1 flex justify-center">
          <img
            src="https://i.ibb.co.com/LhSDZbY8/72bb0e9b-1a9c-40ab-949f-a3bbb1855171.png"
            alt="Profile"
